...
//		}
    ...
    void updateList() {
	    ...
	    try {
//	    	dialog = ProgressDialog.show(WhisprabbitActivity.this, "", "Loading. Please wait...", true);
			...
			for (int i = 0; i < length; i++) {
			  ...
			  Thread thread = new Thread(jo.getString("t_id"), jo.getString("content"));
...
//		Toast.makeText(getApplicationContext(), thread.getT_id(), Toast.LENGTH_SHORT).show();
